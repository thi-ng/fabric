...
#+BEGIN_SRC clojure :noweb-ref handler
  ...
  (defmethod api-response ["*/*" :default]
    [_ body rtype] (api-response "application/edn" body rtype))
  ...
  (defmethod api-response ["application/edn" :default]
    [_ body _] [(pr-str body) "application/edn"])
  ...
  (defmethod api-response ["application/json" :default]
    [_ body _]
    [(json/write-str (transform-body* body) :escape-slash false)
     "application/json"])
  ...
  (defmethod api-response ["text/csv" :list]
    [_ body _]
    (let [body (into [(:columns body)] (:body body))]
      (info :csv-list body)
      [(with-open [out (java.io.StringWriter.)]
         (csv/write-csv out (transform-body* body))
         (.toString out))
