...
* thi.ng.fabric.test.transclosure
...
#+BEGIN_SRC clojure :noweb-ref const
  ;; test fragment of top-level classes of phylogenetic Tree Of Life
...
#+BEGIN_SRC clojure :noweb-ref tests
  (defn valid-closure?
    [g] (= expected-closure (fu/sorted-vertex-values (f/vertices g))))
...
#+BEGIN_SRC clojure :tangle ../babel/test/thi/ng/fabric/test/transclosure.cljc :noweb yes :mkdirp yes :padline no
