...
* Contents                                                         :toc_3_gh:
 - [[#about-the-project][About the project]]
     ...
     - [[#example-usage][Example usage]]
         ...
         - [[#fabric-facts-module-example][fabric-facts module example]]
...
Extra features provided by sub-modules:

- Knowledge graphs (triples & quads)
- Fully featured, efficient query engine (pattern based, variables,
  sub-queries, joins, optional joins, unions, negation, filters,
  pre-filters, grouping, value injection, aggregation)
...
- Easy-to-use API
- Literate programming format w/ diagrams & examples

See the README of the *[[./fabric-facts/README.org][fabric-facts]]* & *[[./fabric-ld/README.org][fabric-ld]]* modules for full feature sets.
