...
the best demonstation of usage patterns and also show most of the
...
|            | Synchronous (naive) | Probabilistic | Probabilistic (eager) | Eager async |  Two-pass |
|------------+---------------------+---------------+-----------------------+-------------+-----------|
| Factor     |                   1 |     3.6402266 |             5.8144796 |   5.7111111 | 3.4175532 |
|------------+---------------------+---------------+-----------------------+-------------+-----------|
