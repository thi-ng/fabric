...
* Contents                                                         :toc_3_gh:
 - [[#about-the-project][About the project]]
     ...
     - [[#example-usage][Example usage]]
         - [[#fabric-coretestsssporgsingle-source-shortest-path][[[./fabric-core/test/sssp.org][Single-source shortest path]]]]
         - [[#fabric-coretestvertexcoloringorgvertex-coloring-in-random-graphs][[[./fabric-core/test/vertexcoloring.org][Vertex coloring in random graphs]]]]
         - [[#fabric-coretesttransclosureorgtransitive-closure-type-inheritance-example][[[./fabric-core/test/transclosure.org][Transitive closure (type inheritance example)]]]]
         - [[#fabric-factstestcoreorgautomatically-updating-fact-graph-queries-with-rule-based-inferencing][[[./fabric-facts/test/core.org][Automatically updating fact graph queries with rule based inferencing]]]]
 - [[#modules][Modules]]
...
*** [[./fabric-core/test/sssp.org][Single-source shortest path]]

[[./assets/sssp.png]]

*** [[./fabric-core/test/vertexcoloring.org][Vertex coloring in random graphs]]

[[./assets/vcolor.png]]

*** [[./fabric-core/test/transclosure.org][Transitive closure (type inheritance example)]]

[[./assets/transclosure.png]]

*** [[./fabric-facts/test/core.org][Automatically updating fact graph queries with rule based inferencing]]
