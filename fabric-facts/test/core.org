...
*** Queries from spec & result transformations
...
#+BEGIN_SRC clojure :noweb-ref tests
  ...
  (deftest test-qspec-aggregation
    (let [g    (ff/fact-graph)
      ...
      (warn :agg1 @q1)
      (warn :agg2 @q2)
      (is (= '#{{?b b1, ?p 10, ?total 120, ?avg 30.0, ?mean 20, ?num 4, ?min 10, ?max 70}
                {?b b1, ?p 70, ?total 120, ?avg 30.0, ?mean 20, ?num 4, ?min 10, ?max 70}
                {?b b2, ?p 20, ?total 120, ?avg 30.0, ?mean 20, ?num 4, ?min 10, ?max 70}
                {?b b1, ?p 20, ?total 120, ?avg 30.0, ?mean 20, ?num 4, ?min 10, ?max 70}}
             @q1))
      (is (= '{b1 [{?b b1, ?p 10, ?total 100, ?avg 33.33333333333333, ?mean 20, ?num 3, ?min 10, ?max 70}
                   {?b b1, ?p 20, ?total 100, ?avg 33.33333333333333, ?mean 20, ?num 3, ?min 10, ?max 70}
                   {?b b1, ?p 70, ?total 100, ?avg 33.33333333333333, ?mean 20, ?num 3, ?min 10, ?max 70}]
               b2 [{?b b2, ?p 20, ?total 20, ?avg 20.0, ?mean 20, ?num 1, ?min 20, ?max 20}]}
             @q2))))
#+END_SRC
