...
digraph g {
  ...
  subgraph cluster1 {
    ...
    f1[label="FactVertex 1", color="#ff0033"];
    f2[label="FactVertex 2", color="#ff0033"];

    FactIndex[color="#ff6600"];
    iv1[label="IndexVertex 1", color="#ff6600"];
    iv2[label="IndexVertex 2", color="#ff6600"];
    iv3[label="IndexVertex N", color="#ff6600"];
    ...
    ftx[label="FactTransform", color="#ff3333"];
    FactGraph -> ftx;
    ftx -> f1; ftx -> f2;

    FactIndex -> iv1[style="dashed"];
    iv1 -> isel1;
    FactIndex -> iv2[style="dashed"];
    iv2 -> isel2;
    FactIndex -> iv3[style="dashed"];
    iv3 -> isel3;
    iv3 -> isel4;
    ...
    nt[label="N-Triples"];
    edn[label="EDN"];
    conv[label="Fact import/\nconversion"];

    nt -> conv;
    edn -> conv;
    conv -> FactGraph[style="dashed"];
  }
}
#+END_SRC
