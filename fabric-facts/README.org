...
This module provides the following features on top of the core compute
graph setup:

- Triple or Quad fact graphs
- Fact indexing
- Fact graph logging (via [[https://github.com/clojure/core.async][core.async]])
...
- Queries are only computed once, results are cached and updated
...
information can be found in the core namespace and tests. Literate
programming FTW!

* Namespaces

- [[./src/core.org][thi.ng.fabric.facts.core]]
- [[./src/dsl.org][thi.ng.fabric.facts.dsl]]
- [[./src/nt.org][thi.ng.fabric.facts.io.ntriples]]
