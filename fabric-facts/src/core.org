...
#+BEGIN_SRC dot :tangle ../../assets/facts-overview.dot :exports none
digraph g {
  ...
  subgraph cluster1 {
    ...
    q1[label="Query", color="#0099cc"];
    q2[label="Query", color="#0099cc"];
    q3[label="Query", color="#0099cc"];

    qcache[label="Query cache", color="#6699cc"];
    selcache[label="Selection cache", color="#cc9999"];

    ComputeGraph -> FactGraph -> f1; FactGraph -> f2;
    f1 -> iv1; f1 -> iv2; f1 -> iv3;
    f2 -> iv1; f2 -> iv2; f2 -> iv3;

    FactGraph -> FactIndex -> selcache;
    FactGraph -> qcache;
    ...
    selcache -> isel1; selcache -> isel2; selcache -> isel3; selcache -> isel4;
    qcache -> q1; qcache -> q2; qcache -> q3;
  }
}
#+END_SRC
